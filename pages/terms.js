  ...
  <Layout>
    ...
    <div className="wrap">
      <div className="main-content">
        ...
        <p>
          This website is operated by Lotto World Group. Throughout the site,
          the terms “we”, “us” and “our” refer to www.lottoworldgroup.com, Lotto
          World Groupoffers this website, including all information, tools and
        ...
        <h1 className="item-title">ONLINE STORE TERMS</h1>
        <p>
          By agreeing to these Terms of Service, you represent that you are at
          least the age of majority in your province of residence.
        </p>
        <p>
        ...
        <h1 className="item-title">GENERAL CONDITIONS</h1>
        <p>
        ...
        <h1 className="item-title">MODIFICATIONS TO THE SERVICE AND PRICES</h1>
        ...
        <h1 className="item-title">PRODUCTS OR SERVICES (if applicable)</h1>
        <p>
        ...
        <p>
          ...
          any person, geographic region or jurisdiction. We reserve the right to
        ...
        <h1 className="item-title">PERSONAL INFORMATION</h1>
        <p>
          Your submission of personal information through the store is governed
          by our Privacy Policy.
        </p>
        <h1 className="item-title">ERRORS, INACCURACIES AND OMISSIONS</h1>
        <p>
        ...
        <h1 className="item-title">PROHIBITED USES </h1>
        <p>
        ...
        <p>
          In no case shall www.lottoworldgroup.com our directors, officers,
        ...
        <h1 className="item-title">INDEMNIFICATION</h1>
        <p>
          You agree to indemnify, defend and hold harmless
          www.lottoworldgroup.com, and our parent, subsidiaries, affiliates,
        ...
        <h1 className="item-title">SEVERABILITY</h1>
        <p>
        ...
        <h1 className="item-title">TERMINATION</h1>
        <p>
        ...
        <h1 className="item-title">ENTIRE AGREEMENT</h1>
        <p>
        ...
        <h1 className="item-title">GOVERNING LAW</h1>
        <p>
          These Terms of Service and any separate agreements whereby we provide
          you Services shall be governed by and construed in accordance with the
          laws of British Columbia, Canada.
        </p>
        <h1 className="item-title">CHANGES TO TERMS OF SERVICE</h1>
        <p>
        ...
        <h1 className="item-title">CONTACT INFORMATION</h1>
        <p>
          Questions about the Terms of Service should be sent to{" "}
          <a href="mailto:info@buybodymodscanada.com">
            info@buybodymodscanada.com
          </a>
        </p>
      </div>
    </div>
